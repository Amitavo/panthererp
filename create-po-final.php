...
<body id="page-top">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body" id="export-area">
                  <div class="container">
                    <div class=" container-fluid ">
                ...
                <div class="row ">
                  ...
                  <div class="col-6 mt-5 mb-5 text-right">
                    ...
                    <button id="btnExport" type="button" class="btn btn-outline-secondary justify-content-end mr-5">Export PDF</button>


                    <a id="goToSubmitPo" href='create-po-final-submit.php' class="btn btn-primary pl-5 pr-5 ml-2 mr-5">Submit PO</a>
                  </div>
  ...
  <!-- Script for making PDF -->
  <script type="text/javascript">
    jQuery(document).ready(function() {
      function downloadPdf(callback) {
        html2canvas($('#export-area')[0], {
          onrendered: function(canvas) {
            ...
            pdfMake.createPdf(docDefinition).download("purchase_order.pdf", function() {
              if (callback) {
                callback();
              }
            });
      ...
      $('#goToSubmitPo').on('click', function(e) {
        e.preventDefault();
        downloadPdf(function() {
          window.location.href = e.target.getAttribute('href');
        });
      })
      $("body").on("click", "#btnExport", downloadPdf);
    })
  </script>
