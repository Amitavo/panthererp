...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    // echo $vendor_name.$vendor_number.$vendor_address.$vendor_email.$vendor_gst_no;
  }
} else {
  echo "0 results";
}
                      ...
                      <div class="col-12">
                        ...
                        if ($result1->num_rows > 0) {
                          ...
                          while($row = $result1->fetch_assoc()) {
                            ...
                            echo "Total price is : ". $item1_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result2->num_rows > 0) {
                          ...
                          while($row = $result2->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item2_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result3->num_rows > 0) {
                          ...
                          while($row = $result3->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item3_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result4->num_rows > 0) {
                          ...
                          while($row = $result4->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item4_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result5->num_rows > 0) {
                          ...
                          while($row = $result5->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item5_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result6->num_rows > 0) {
                          ...
                          while($row = $result6->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item6_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result7->num_rows > 0) {
                          ...
                          while($row = $result7->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item7_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result8->num_rows > 0) {
                          ...
                          while($row = $result8->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item8_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result9->num_rows > 0) {
                          ...
                          while($row = $result9->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item9_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result10->num_rows > 0) {
                          ...
                          while($row = $result10->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item10_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result11->num_rows > 0) {
                          ...
                          while($row = $result11->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item11_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        if ($result12->num_rows > 0) {
                          ...
                          while($row = $result12->fetch_assoc()) {
                            ...
                            echo "<br>Total price is : ". $item12_total;
                          }
                        } else {
                          echo "bad results";
                        }
                        ...
                        <table class="table  mt-5">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="font-weight-bold">5692</td>
                            </tr>
                          </tbody>
                        </table>
                        ...
                        <div class="row ">
                          <div class="col-6">
                            <div class="card">
                              <div class=" ">
                                ...
                                <textarea name="comment" id="comment" cols="53" rows="3" placeholder="Insert you comment here..."></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-6 mt-5 ">
                            ...
                            <button type="submit" class="btn btn-primary pl-5 pr-5 ml-5" name="Submit">Submit</button>
                          </div>
