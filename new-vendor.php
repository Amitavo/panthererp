    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Create a New Vendor</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">New Vendor</h6>
                </div>
                <div class="card-body">
                  <div class="container">
                    <div class=" container-fluid ">
                      <h2 class="text-center font-weight-bold mb-5"><u>Unique International New Vendor</u></h2>
                    </div>
                    <div class="row">
